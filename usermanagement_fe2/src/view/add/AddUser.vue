<template>
    <form @submit.prevent="">
        <div class="row mb-3">
            ...
            <div class="col-md-6 title">Thêm người dùng</div>
            <div class="col-md-3"></div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-12 text-center">
                <button @click="handleAddUser()" class="addUser">Thêm</button>&nbsp;
                <button @click="deleteAddUser()" class="delete">Hủy</button>
            </div>
        </div>
    </form>
...
<script>
    ...
    export default {
        ...
        methods: {
            deleteAddUser() {
                this.$store.state.user.buttonShowAdd = false;
            },
            handleAddUser() {
                let team = new Team();
                ...
                if (ValidateUser.checkUser(this.user)) {
                    AdminService.addUser(this.user).then(
                        () => {
                            this.loadingData();
                        },
                        error => {
